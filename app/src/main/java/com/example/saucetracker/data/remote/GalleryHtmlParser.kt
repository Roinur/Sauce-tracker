...
import com.example.saucetracker.CreatorLink
import com.example.saucetracker.HTML_TAG_PATTERN
import com.example.saucetracker.POPULAR_TAG_ANCHOR_PATTERN
import com.example.saucetracker.POPULAR_TAG_COUNT_SPAN_PATTERN
import com.example.saucetracker.POPULAR_TAG_NAME_SPAN_PATTERN
import com.example.saucetracker.UPLOAD_DATE_FORMAT
import com.example.saucetracker.normalizeTagName
import com.example.saucetracker.parseCoverExtension
...
internal object GalleryHtmlParser {
    ...
    fun parsePopularTags(html: String): List<com.example.saucetracker.PopularTagSeed> {
        val rows = mutableListOf<com.example.saucetracker.PopularTagSeed>()
        POPULAR_TAG_ANCHOR_PATTERN.findAll(html).forEach { match ->
            ...
            if (name.isNotBlank()) {
                rows += com.example.saucetracker.PopularTagSeed(name, type, parseCompactCount(countHtml))
            }
        }
