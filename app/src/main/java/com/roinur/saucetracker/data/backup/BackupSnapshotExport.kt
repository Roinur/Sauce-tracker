...
import com.roinur.saucetracker.HiddenSuggestedEntryState
import com.roinur.saucetracker.SavedStats
import com.roinur.saucetracker.SuggestionWeightCategory
import com.roinur.saucetracker.UTC_TIMESTAMP_FORMAT
import com.roinur.saucetracker.csvEscape
...
internal object BackupSnapshotExport {
    ...
    fun mergeProceduralSnapshots(
        ...
        return JSONObject(latestSnapshot.toString()).apply {
            ...
            val portablePreferences = latestSnapshot.optJSONObject(PortablePreferences.SNAPSHOT_KEY)
                ?: existingSnapshot.optJSONObject(PortablePreferences.SNAPSHOT_KEY)
            portablePreferences?.let {
                put(PortablePreferences.SNAPSHOT_KEY, copyJsonObject(it))
            }
        }
    }
